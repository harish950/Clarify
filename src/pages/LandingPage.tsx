    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 pt-24 pb-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Navigate your career with <span className="text-gradient">clarity</span>
          </motion.h1>
          ...
          >
            Visualize career opportunities as an interactive map. See which roles fit your skills, what you need to
            learn, and how to get there.
          </motion.p>
            ...
            <div className="aspect-[16/10] bg-muted/50 rounded-xl flex items-center justify-center relative">
              ...
              <div className="relative">
                ...
                <svg
                  ...
                  style={{ left: -120, top: -100, width: 300, height: 240 }}
                >
                  {[
                    { x: 50, y: 60 },
                    { x: 250, y: 80 },
