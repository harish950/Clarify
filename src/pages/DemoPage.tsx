...
const DemoPage = () => {
  ...
  const { nodes, edges } = useMemo(() => {
    ...
    const secondaryNodes: Node[] = [
      ...
      { id: "pm", label: "Product Manager", x: cx + w * 0.2, y: cy - 60, size: 16, isSecondary: true },
    ...
    const tertiaryNodes: Node[] = [
      ...
      { id: "roadmap", label: "Roadmaps", x: cx + w * 0.3, y: cy - 10, size: 6 },
      { id: "analytics", label: "Analytics", x: cx + w * 0.12, y: cy - 20, size: 6 },
      { id: "python", label: "Python", x: cx - w * 0.3, y: cy + 80, size: 8 },
      ...
      { id: "research", label: "Research", x: cx + w * 0.3, y: cy + 30, size: 5 },
    ...
    <div ref={containerRef} className="fixed inset-0 overflow-hidden bg-graph-bg cursor-default select-none">
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none">
        ...
        {edges.map((edge, i) => {
          ...
          const isHighlighted =
            edge.from === highlightedId ||
            edge.to === highlightedId ||
